...
export function createServer() {
    ...
    registerAppTool(server, "compose_email", {
        ...
        const { to = [], cc = [], bcc = [], subject = "", body = "", signature = "", reply_to_thread_id, reply_to_message_id, draft_id } = args;
        let draft;
    ...
    registerAppTool(server, "update_draft", {
        title: "Update Draft",
    ...
    registerAppTool(server, "send_email", {
        title: "Send Email",
    ...
    registerAppTool(server, "save_draft", {
        title: "Save Draft",
    ...
    registerAppTool(server, "discard_draft", {
        title: "Discard Draft",
